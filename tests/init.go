...
var Forks = map[string]*params.ChainConfig{
	...
	// Synthetic blob schedules independently exercise Amsterdam increases and decreases.
	"BPOIncrease": {
		ChainID:                 big.NewInt(1),
		HomesteadBlock:          big.NewInt(0),
		EIP150Block:             big.NewInt(0),
		...
		BlobScheduleConfig: &params.BlobScheduleConfig{
			...
			BPO1:        params.DefaultBPO1BlobConfig,
			BPO2:        params.DefaultBPO2BlobConfig,
			BPOIncrease: params.DefaultBPOIncreaseBlobConfig,
		},
	},
	...
	"BPODecrease": {
		...
		BlobScheduleConfig: &params.BlobScheduleConfig{
			...
			BPO1:        params.DefaultBPO1BlobConfig,
			BPO2:        params.DefaultBPO2BlobConfig,
			BPODecrease: params.DefaultBPODecreaseBlobConfig,
		},
	},
	"AmsterdamToBPODecreaseAtTime15k": {
		ChainID:                 big.NewInt(1),
		HomesteadBlock:          big.NewInt(0),
		EIP150Block:             big.NewInt(0),
		EIP155Block:             big.NewInt(0),
